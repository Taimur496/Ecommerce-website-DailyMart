      ...
      <Row className="p-2">
        ...
        >
          ...
          <p className="section-title-contact">
            ...
            a project-based course that helps you to learn professionally and
            make you fell as a complete developer. easy learning exists to help
            you succeed in life.<br></br>
            <br></br>
