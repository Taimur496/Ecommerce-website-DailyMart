...
import { User, Mail, Save, AlertCircle, Camera, Shield } from "lucide-react";
...
const AdminProfile = () => {
  ...
  const getProfileImage = () => {
    ...
    // Use profile_photo_url from backend
    if (user?.profile_photo_url) {
      return user.profile_photo_url;
    }

    // Fallback to profile_photo_path
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await adminAPI.updateProfile(formDataToSend);
  ...
  return (
    <div className="container mt-3">
      <div className="row custom-profile-dispaly justify-content-center">
        <div className="admin-profile-width col-md-8">
        ...
        <div className="admin-profile-width col-md-4">
          <div className="card shadow-sm">
            <div className="card-body">
              ...
              <div className="row">
                ...
                <div className="col-6">
                  <small className="text-muted">Email Verification:</small>
                  <p className="mb-0">
